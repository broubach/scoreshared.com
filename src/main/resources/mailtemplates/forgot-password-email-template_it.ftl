						...
						<table width="100%">
							<tr>
								<td>
									...
									<p>Se sì, visitare <a href="http://www.scoreshared.com/app/forgotPassword/resetPassword?hash=${hash}" style="color:#069054">http://www.scoreshared.com/forgotPassword/resetPassword?hash=${hash}</a> per riavviare la password. Questa pagina sarà disponibile per 2 giorni.</p>
