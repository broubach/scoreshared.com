...
CREATE TABLE `player` (
  ...
  `invitationShouldNotBeRemembered` bit(1) DEFAULT NULL,
  `deleted` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `playerpermission`
--

DROP TABLE IF EXISTS `playerpermission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `playerpermission` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `player_id` int(10) unsigned NOT NULL,
  `approvalResponse` int(11) DEFAULT NULL,
  `visible` bit(1) NOT NULL,
  `revisionMessage` varchar(45) DEFAULT NULL,
  `deleted` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `playerpermission`
--

LOCK TABLES `playerpermission` WRITE;
/*!40000 ALTER TABLE `playerpermission` DISABLE KEYS */;
/*!40000 ALTER TABLE `playerpermission` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `score_playerpermission_left`
--

DROP TABLE IF EXISTS `score_playerpermission_left`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `score_playerpermission_left` (
  `score_id` int(10) unsigned NOT NULL,
  `playerpermission_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`score_id`,`playerpermission_id`),
  KEY `fk_score_playerleft_score` (`score_id`),
  KEY `fk_score_playerleft_playerpermission` (`playerpermission_id`),
  CONSTRAINT `fk_score_playerleft_playerpermission` FOREIGN KEY (`playerpermission_id`) REFERENCES `playerpermission` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
-- Dumping data for table `score_playerpermission_left`
--

LOCK TABLES `score_playerpermission_left` WRITE;
/*!40000 ALTER TABLE `score_playerpermission_left` DISABLE KEYS */;
/*!40000 ALTER TABLE `score_playerpermission_left` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `score_playerpermission_right`
--

DROP TABLE IF EXISTS `score_playerpermission_right`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `score_playerpermission_right` (
  `score_id` int(10) unsigned NOT NULL,
  `playerpermission_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`score_id`,`playerpermission_id`),
  KEY `fk_score_playerright_score` (`score_id`),
  KEY `fk_score_playerright_playerpermission` (`playerpermission_id`),
  CONSTRAINT `fk_score_playerright_playerpermission` FOREIGN KEY (`playerpermission_id`) REFERENCES `playerpermission` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_score_playerright_score` FOREIGN KEY (`score_id`) REFERENCES `score` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `score_playerpermission_right`
--

LOCK TABLES `score_playerpermission_right` WRITE;
/*!40000 ALTER TABLE `score_playerpermission_right` DISABLE KEYS */;
/*!40000 ALTER TABLE `score_playerpermission_right` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-01-28 17:59:37
