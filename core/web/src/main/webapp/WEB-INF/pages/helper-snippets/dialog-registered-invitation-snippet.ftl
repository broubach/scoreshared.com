...
<div id="dialog-registeredInvitation" class="modal mfp-hide">
	...
	<div class="row content no-padding-top no-padding-bottom">
		<div class="columns large-12 direita">
			<a class="button button-primary mfp-prevent-close" id="dialog-registeredInvitation-send_invitation"><@spring.message code="label.invite"/></a>
			<a class="button mfp-prevent-close" id="dialog-registeredInvitation-save_without_invitation"><@spring.message code="label.save_without_invitation"/></a>
			<a class="button button-warning mfp-prevent-close" id="dialog-registeredInvitation-back"><@spring.message code="label.back"/></a>
		</div>
	</div>
</div>