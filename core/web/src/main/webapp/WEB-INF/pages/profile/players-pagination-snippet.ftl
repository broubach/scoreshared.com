					...
					<div class="columns small-12">
						<div class="pagination-centered">
							<ul class="pagination">
								...
								<li class="arrow <#if disableLastArrow!false>unavailable</#if>"><a href="<#if !disableLastArrow!false><@spring.url relativeUrl="/app/profile/players/page/${pageCount-1}/ascending/${ascending?c}"/><#else>#</#if>">&raquo;</a></li>
							</ul>
						</div>
					</div>
				</div>
