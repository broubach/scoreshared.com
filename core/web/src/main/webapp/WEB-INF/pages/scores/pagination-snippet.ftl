					...
					<div class="columns small-12">
						<div class="pagination-centered">
							<ul class="pagination">
								...
								<li class="arrow <#if disableLastArrow!false>unavailable</#if>"><a href="<#if !disableFirstArrow!false><@spring.url relativeUrl="/app/scores/${pageCount-1}/${outcome}/${ascending?c}"/><#else>#</#if>">&raquo;</a></li>
							</ul>
						</div>
					</div>
				</div>
