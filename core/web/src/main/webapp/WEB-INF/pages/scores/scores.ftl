...
<head>
	...
	<#assign head_additional_js=["/js/vendor/Chart.min.js", 
								...
								"/js/vendor/select2-3.4.5.min.js"]>
...
<body>
	...
	<div class="content row">
		<nav class="breadcrumbs">
			...
			<a href="<@spring.url relativeUrl="/app/home"/>"><@spring.message code="label.home"/></a> <a href="#" class="current"><@spring.message code="label.my_scores"/></a>
		</nav>
