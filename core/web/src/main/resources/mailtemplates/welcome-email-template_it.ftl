...
<title>Benvenuto a scoreshared!</title>
</head>
				...
				<tr>
					...
					<td class="container" bgcolor="#FFFFFF">
						...
						<table width="100%">
							<tr>
								<td>
									<p>Benvenuto ${firstName}!<br>
									<p>Siamo lieti di accoglierti.</p>
									<p>Per tornare avrai bisogno della password, che stiamo inviando prima di cifrarla nei nostri server. Dopo di questo né anche noi saremmo capace di dire qual'è la tua password non cifrata.</p>
									<p>Password: ${password}</p>
									<p>Caso perdere la password, utilizzi la funzione "Ho dimenticato la password".</p>
									<p>Cordiale saluto,<br/>Scoreshared team</p>
