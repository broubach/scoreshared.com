						...
						<table width="100%">
							<tr>
								<td>
									...
									<p>If so, visit <a href="${http_server_address_port}/app/forgotPassword/resetPassword?hash=${hash}" style="color:#069054">${http_server_address_port}/app/forgotPassword/resetPassword?hash=${hash}</a> to reset your password. This page will be valid for 2 days.</p>
