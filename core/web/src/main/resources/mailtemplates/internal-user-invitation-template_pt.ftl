						...
						<table width="100%">
							<tr>
								<td>
									...
									<p>Se você quiser aceitar o convite e começar a acompanhar seus resultados com essa pessoa, por favor aceite o convite em <a href="${http_server_address_port}">www.scoreshared.com</a>.</p>
