						...
						<table width="100%">
							<tr>
								<td>
									...
									<p>Se sim, visite <a href="${http_server_address_port}/app/forgotPassword/resetPassword?hash=${hash}" style="color:#069054">${http_server_address_port}/app/forgotPassword/resetPassword?hash=${hash}</a> para reiniciar a sua senha. Esta página será válida por 2 dias.</p>
										...
										<tr>
											<td>
												...
												<table align="left" class="column" width="15%">
													<tr>
														<td>				
															<h5 class="">Conecte-se conosco:</h5>
