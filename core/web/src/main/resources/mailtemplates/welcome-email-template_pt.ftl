...
<title>Bem-vindo ao scoreshared!</title>
</head>
				...
				<tr>
					...
					<td class="container" bgcolor="#FFFFFF">
						...
						<table width="100%">
							<tr>
								<td>
									<p>Bem-vindo ${firstName}!<br>
									<p>Estamos felizes em receber você.</p>
									<p>Para você poder voltar, estamos enviando a sua senha pouco antes de criptografá-la em nossos servidores. Depois disso nem nós seremos capazes de dizer qual é a sua senha descriptografada.</p>
									<p>Senha: ${password}</p>
			
									<p>Caso você perca esse email, use a função "Esqueci minha senha".</p>
