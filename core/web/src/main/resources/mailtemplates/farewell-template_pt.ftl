				...
				<tr>
					...
					<td class="container" bgcolor="#FFFFFF">
						...
						<table width="100%">
							<tr>
								<td>
									<p>Obrigado, ${firstName}!<br>
									<p>Sentimos muito por estar nos deixando.</p>
									<p>Esperamos que você tenha deixado suas razões para encerramento de conta na página de despedida. Caso ainda não o tenha feito, você será sempre bem vindo para nos enviar sua opinião em contact@scoreshared.com.</p>
									<p>Estaremos sempre a espera de seu retorno.</p>
